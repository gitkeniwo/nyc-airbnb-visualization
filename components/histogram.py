...
# Create a list with known values in neighbourhood_group column
...
def target_graph(type):
    # viz_3=sns.catplot(x='neighbourhood', hue='neighbourhood_group', col='room_type', data=room_type[type],
    # kind='count') viz_3.set_xticklabels(rotation=90)
