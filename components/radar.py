...
def get_data():
    ...
    attribute = ['neighbourhood', 'neighbourhood_group', 'room_type', 'age', 'nei_price', 'service_fee',
                 'minimum_nights', 'availability_365']
    df_radar = airbnb[attribute].dropna()
    df_radar = df_radar[df_radar['availability_365'] <= 365]
    df_radar = df_radar[df_radar['minimum_nights'] < 2000]
    df_radar = df_radar[df_radar['neighbourhood_group'] != 'brookln']
    return df_radar
